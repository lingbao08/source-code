...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    private static final int DEFAULT_NUM_HEAP_ARENA;// 默认2*CPU
    private static final int DEFAULT_NUM_DIRECT_ARENA;// 默认2*CPU

    private static final int DEFAULT_PAGE_SIZE;
    private static final int DEFAULT_MAX_ORDER; // 8192 << 11 = 16 MiB per chunk
    private static final int DEFAULT_SMALL_CACHE_SIZE;  // 默认是256
    private static final int DEFAULT_NORMAL_CACHE_SIZE;  // 默认是64
    static final int DEFAULT_MAX_CACHED_BUFFER_CAPACITY;
    private static final int DEFAULT_CACHE_TRIM_INTERVAL;
    private static final long DEFAULT_CACHE_TRIM_INTERVAL_MILLIS;
    private static final boolean DEFAULT_USE_CACHE_FOR_ALL_THREADS;
    private static final int DEFAULT_DIRECT_MEMORY_CACHE_ALIGNMENT; // 默认是0，需要是2的次方
    ...
    static {
         ...
         *
         * 我们使用2*可用处理器数量（CPU核数）作为默认值。以减少竞争，我们也使用2*处理器数量作为EventLoops在NIO和EPOLL中的数量。
         * 当我们选择一个小一点的数字时，我们在分配和取消分配时就需要用到synchronized在PoolArena上。
         */
    ...
    final class PoolThreadLocalCache extends FastThreadLocal<PoolThreadCache> {
        ...
        protected synchronized PoolThreadCache initialValue() {
            // heapArenas 和directArenas 的默认数组长度 都是2*CPU核数
